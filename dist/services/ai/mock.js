...
const exampleGeneratedResponses = {
    responses: [
        ...
        },
        {
            ...
            explanations: {
                personality: "The Pixar crying confession is relatable and adds emotional honesty with humor.",
                tone_fit: "Funny and self-aware, great for dating but slightly less flirty.",
                brevity_clarity: "Short, well-structured, and punchy.",
                originality: "Pixar tears are familiar but 'cardio' twist adds flavor.",
                conversation_spark: "No direct question, but definitely opens room for shared confessions.",
            },
            overall_score: 8.1,
        ...
        },
        {
            ...
            explanations: {
                personality: "Travel, tennis, and humor combined create a vivid and interesting personality snapshot.",
                tone_fit: "Playful with a hint of absurdity—charming and bold.",
                brevity_clarity: "Slightly longer but still within range and cleanly written.",
                originality: "Tokyo tennis with matcha is delightfully weird and fresh.",
...
const exampleRevisedResponse = "I won't shut up about fermenting everything from carrots to miso. Ever made your own pickles?";
const exampleEvaluation = {
    ...
    explanations: {
        personality: "The response feels warm and genuine, giving a clear glimpse into your lifestyle and priorities like early routines and your pup.",
        tone_fit: "Tone is casual and dating-appropriate—friendly, easygoing, and welcoming.",
        brevity_clarity: "It's slightly wordy but still easy to read and understand.",
        originality: "Coffee runs and beach walks are pleasant but fairly common; it could use a more unique or specific twist.",
        conversation_spark: "It paints a nice picture but doesn't explicitly invite engagement or follow-up.",
    },
    overall_score: 7.2,
    label: "🟡 Room to Grow",
    suggestions: [
...
const exampleImprovedResponse = "I'm looking for someone who's down for sunrise matcha walks on Venice Beach with Max—too much morning energy for you?";
class MockAIService {
    async generatePromptSuggestions(userProfile) {
        console.log("Mock AI: Generating prompt suggestions for", userProfile);
        return Promise.resolve(exampleGeneratedResponses);
    }
    async revisePromptSuggestion(prompt, response, evaluation, feedback) {
    ...
    async evaluateUserPrompt(prompt, response) {
        console.log("Mock AI: Evaluating user prompt:", response);
        return Promise.resolve(exampleEvaluation);
    }
    async reviseUserPrompt(prompt, response, evaluation, suggestions) {
